function [H, V, E]  = Tensor_Interaction(kx,ky,kz, spins, zfs, H_mag)
%
%   Constructs the Hamiltonian of interacting spins.
%   Hamiltonian H eigenvectors V and the eigenvalues E
%   spins is a 1D array containing the spins of each interacting particle
%   ks is a 2D array containing the coupling between each spin
%   H_mag is the applied magnetic field on the particles
%   
...
for n = 1:length(spins)
    ...
    s = spin_matrix_z(spins(n))*H_mag(n);
...
%KRON_POW Creates a chain of tensor products of identity matrices of
%specified dimension.
